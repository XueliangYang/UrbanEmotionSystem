...
def load_data():
    ...
    try:
        # 数据路径
        data_path = r'E:\NYU\academic\Y2S2\CUSP-GX-7133\DataManhattan\All_Participant_Process'
        # 优先加载带有优先级标签的数据
        prioritized_file = os.path.join(data_path, 'Man_All_Participant_Labeled_BiLSTM_withEnvGPS_prioritized_50.csv')
        regular_file = os.path.join(data_path, 'Man_All_Participant_Labeled_BiLSTM_withEnvGPS_prioritized_50.csv')
